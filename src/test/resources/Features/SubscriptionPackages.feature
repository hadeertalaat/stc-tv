...
#Date: Jun 8th, 2023
#Description: Validate the subscription packages - type & price and currency for all countries (KSA|Kuwait|Baharin)

Feature: STC TV Subscription Packages
  ...
  Scenario Outline: validate all the available packages in "Choose Your Plan" section
    When user opens stc tv
  ...
  Scenario Outline: validate all the available packages in "Available Add-Ons" section
